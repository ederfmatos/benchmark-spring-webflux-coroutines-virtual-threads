package com.ederfmatos.kotlintomcat.controller

import com.ederfmatos.kotlintomcat.log.Logger
import com.ederfmatos.kotlintomcat.usecase.CreateTransaction
import com.ederfmatos.kotlintomcat.usecase.GetTransaction
...
class TransactionController(
    ...
    fun createTransaction(@RequestBody input: CreateTransaction.Input): CreateTransaction.Output {
        logger.info {
    ...
    fun getTransaction(@PathVariable id: String): GetTransaction.Output {
        logger.info {
